/*************************************************************
 * CONFIGRATION BIT SETTING FILE FOR 16F1509
 * Author	: 石倉万希斗
 * Latest	: 2012/12/28 19:50
*************************************************************/
//CONFIG1とCONFIG2に分ける。
...
__CONFIG( BOREN_OFF & IESO_OFF & FOSC_INTOSC & FCMEN_OFF & MCLRE_ON & WDTE_OFF & CP_OFF & PWRTE_OFF & CLKOUTEN_OFF );
__CONFIG( LPBOR_OFF & WRT_OFF & STVREN_OFF & BORV_LO & LVP_OFF );
